...
function preload(){
  ...
  //
  controle = loadAnimation("dualsense-controller-product-thumbnail-01-en-14sep21");
   //
...
function setup() {
  ...
  sun = createSprite(width-60,100,10,10);
  sun.addAnimation("sun", sunAnimation);
  sun.scale = 0.15;
  
  controle = createSprite(50,height-70,20,50);
  controle.addAnimation("dualsense-controller-product-thumbnail-01-en-14sep21");
